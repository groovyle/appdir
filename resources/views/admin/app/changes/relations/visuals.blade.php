<div class="item field-group">
	<div class="title">{{ __('admin/app.field.visuals') }}</div>
	<div class="visuals comparison">
		...
		<a href="{{ route('admin.apps.changes.visuals', ['app' => $cl->app_id]) }}" class="fas fa-search arrow text-gray ml-2 btn-compare-visuals" title="@lang('common.details')" data-version="{{ $cl->version }}" data-visuals-old="{{ implode(',', $rel['old']->keys()->all()) }}" data-visuals-new="{{ implode(',', $rel['new']->keys()->all()) }}"></a>
	</div>
</div>
