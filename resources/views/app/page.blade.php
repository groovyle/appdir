...
@if($share_enabled)
	...
	@if($app->thumbnail)
	<meta property="og:image" itemprop="image" content="{{ $app->small_thumbnail_url }}">
	@elseif($app->logo)
	...
	<meta property="og:updated_time" content="{{ $app->updated_at->timestamp }}">
							...
							<div class="card-body">
								...
								<div class="user-display vertical mb-2">
									<div class="user-logo-wrapper">
										<img src="{{ $app->owner->profile_picture }}" alt="User image" width="64" height="64">
									</div>
									<div class="user-text">
