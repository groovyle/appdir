		...
		<div class="col-12 col-md-10 col-xl-8 mx-auto">
			<div class="text-center mb-2">
				<a href="{{ route('index') }}" class="d-inline-block" title="{{ __('frontend.navs.home') }}">
					<img src="{{ asset('img/logo-'.$counter_theme.'.png') }}" class="logo d-block mx-auto" alt="{{ app_name() }} logo" style="max-width: 120px;">
					<img src="{{ asset('img/fineprint-'.$counter_theme.'.png') }}" class="logo d-block mx-auto" alt="{{ app_name() }} logo" style="max-width: 96px;">
				</a>
			</div>
