					...
					<tbody>
						...
						<tr class="tag-item-{{ \Str::slug($item->name) }}">
							...
							<td class="text-nowrap">
								...
								<a href="{{ route('admin.app_tags.destroy', array_merge(['tag' => $item->name])) }}" class="btn btn-danger btn-xs text-nowrap btn-ays-modal" data-method="DELETE" data-prompt="_delete" data-description="{{ sprintf('<strong>%s</strong>: %s', __('admin/app_tags._self'), $item->name) }}">
